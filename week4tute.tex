...
If both the strings are \highlight{equal} then this method returns \highlight{0}.

If the current instance is \highlight{greater}, it returns \highlight{positive}.

If the current instance is \highlight{lesser}, it returns \highlight{negative}.
